...
<!-- 
	...
	Wersja CDA_PL_IG_1.3.2:1.0, 20200720
	...
	- CDA_PL_IG_1.3.1:2.3, 7733 linii kodu, autor Marcin Pusz: uwzględnienie przypadku adresu polskiego inline bez ulicy, np. 38-451 Równe 120
	- CDA_PL_IG_1.3.2:1.0, 7741 linii kodu, autor Marcin Pusz: dostosowanie do wersji PIK 1.3.2: przestrzeń nazw extPL/r3, data autorstwa
-->
